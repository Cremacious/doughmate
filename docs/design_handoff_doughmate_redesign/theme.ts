 ...
 * Drop in at app-src/src/theme.ts. Consume tokens everywhere, never hardcode.
 * Names are stable so a themes shop can swap the values later.
 */
...
/** Fonts to load with expo-font: Gabarito, Nunito Sans, Space Grotesk (all Google, OFL). */
export const typography = {
  ...
  label: {
    fontFamily: 'NunitoSans_700Bold', fontSize: 12, lineHeight: 16,
    letterSpacing: 0.96, textTransform: 'uppercase' as const,
  },
  numeric: {
...
export const spacing = {
  '2xs': 4, xs: 8, sm: 12, md: 16, lg: 20, xl: 24, '2xl': 32, '3xl': 40, '4xl': 56,
} as const;
...
export const shadow = {
  none: {},
  sm: { shadowColor: '#4A2A18', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 2, elevation: 1 },
  md: { shadowColor: '#4A2A18', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.10, shadowRadius: 18, elevation: 4 },
  lg: { shadowColor: '#4A2A18', shadowOffset: { width: 0, height: 14 }, shadowOpacity: 0.16, shadowRadius: 36, elevation: 8 },
  sheet: { shadowColor: '#261608', shadowOffset: { width: 0, height: -12 }, shadowOpacity: 0.22, shadowRadius: 40, elevation: 12 },
} as const;
...
export const haptic = {
  tap: 'Light', select: 'Selection', pop: 'Medium',
...
export const theme = {
  palettes, typography, fontScale, touchTarget, spacing, radius, shadow, spring, duration, easing, haptic, sheet,
} as const;
